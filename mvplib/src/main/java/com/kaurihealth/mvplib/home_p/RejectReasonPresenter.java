 ...
 */
public class RejectReasonPresenter<V> implements IRejectReasonPresenter<V> {

    private final IDataSource mRepository;
    private CompositeSubscription mSubscriptions;
    private IRejectReasonView mActivity;

    @Inject
    public RejectReasonPresenter(IDataSource mRepository){
    ...
    public void setPresenter(V view) {
        mActivity = (IRejectReasonView) view;
    }

    @Override
    public void onSubscribe() {
        PatientRequestDecisionBean bean = mActivity.getCurrentPatientRequestDecisionBean();
        Subscription subscription = mRepository.RejectPatientRequest(bean)
