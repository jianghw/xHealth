...
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字背景框
    private int backgroundResource = R.drawable.bg_search_item_text;
    // 关键字水平padding，单位为dp
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                ...
                backgroundResource = typedArray.getResourceId(attr, R.drawable.bg_search_item_text);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(
                    width, widthMode == MeasureSpec.EXACTLY ? MeasureSpec.AT_MOST : widthMode);
            int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(
                    height, heightMode == MeasureSpec.EXACTLY ? MeasureSpec.AT_MOST : heightMode);
    ...
    public void setFlowLayout(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            this.addView(tv, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        }
    }

    public void setFlowLayout(List<String> list, final OnItemDeleteClickListener itemDeleteClickListener) {
        if (!lines.isEmpty()) {
            lines.clear();
            this.removeAllViews();
        }
        for (int i = 0; i < list.size(); i++) {
            ...
            params.setMargins(textPaddingV, 0, 0, 0);
            imageView.setLayoutParams(params);

            effectOfClick(80, imageView);
            ...
            this.addView(linearLayout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));

            final int position = i;
            imageView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    itemDeleteClickListener.onItemClickDelete(position);
                }
            });
        }
    }
