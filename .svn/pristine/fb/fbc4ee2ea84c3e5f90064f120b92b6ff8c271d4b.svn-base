...
public class LobCommonSavePresenter<V> implements ILobCommonSavePresenter<V> {

    private final IDataSource mRepository;
    private CompositeSubscription mSubscriptions;
    private ILobCommonSaveView mActivity;
    private boolean mFirstLoad = true;

    @Inject
    public LobCommonSavePresenter(IDataSource mRepository){
    ...
    public void setPresenter(V view) {
        mActivity = (ILobCommonSaveView) view;
    }
