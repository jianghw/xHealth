...
public class ClinicalOutpatientAdapter extends CommonAdapter<PatientRecordDisplayDto> {

    private ItemClickBack itemClickBack;

    public ClinicalOutpatientAdapter(Context context, List<PatientRecordDisplayDto> list) {
        super(context, list);
    }

    public ClinicalOutpatientAdapter(Context context, List<PatientRecordDisplayDto> list, ItemClickBack itemClickBack) {
        super(context, list);
