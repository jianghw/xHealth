...
public class SupplementTestDialog implements View.OnClickListener, PopupWindow.OnDismissListener  {

    private PopupWindow popupWindow;
    private Activity mActivity;
    private static final String SUBJECT = "辅助检查";
    ...
    public void openPopupWindow_item(Activity context, View v, PopupWindow popupWindow) {
        ...
        //设置PopupWindow的View
        View view = LayoutInflater.from(context).inflate(R.layout.view_popupwindow_supplement, null);
    ...
    TextView tv_cancel,clinical_outpatient,supplement_blood_vessel,
             supplement_other;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clinical_outpatient:
                popupWindow.dismiss();
                ((RecordDetailsActivity)mActivity).getData(SUBJECT,clinical_outpatient.getText().toString());
                break;
            case R.id.supplement_blood_vessel:
                popupWindow.dismiss();
                ((RecordDetailsActivity)mActivity).getData(SUBJECT,supplement_blood_vessel.getText().toString());
                break;
            case R.id.supplement_other:
                popupWindow.dismiss();
                ((RecordDetailsActivity)mActivity).getData(SUBJECT,supplement_other.getText().toString());
                break;
        }
    }
