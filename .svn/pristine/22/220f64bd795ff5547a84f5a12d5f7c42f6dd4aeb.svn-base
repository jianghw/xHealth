 ...
 */
public class MedicTypeMessageHandler extends AVIMTypedMessageHandler<MedicalTypeMessage> {

    private Context context;

    public MedicTypeMessageHandler(Context context) {
     ...
     */
    @Override
    public void onMessage(final MedicalTypeMessage message, final AVIMConversation conversation, AVIMClient client) {
    ...
    @Override
    public void onMessageReceipt(MedicalTypeMessage message, AVIMConversation conversation, AVIMClient client) {
