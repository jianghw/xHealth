...
public class ClinicalDialog implements View.OnClickListener, PopupWindow.OnDismissListener {


    private PopupWindow popupWindow;
    private Activity mActivity;
    private static final String  MEDICALCASE= "临床诊疗";
    ...
    public void openPopupWindow_item(Activity context, View v, PopupWindow popupWindow) {
        ...
        //设置PopupWindow的View
        View view = LayoutInflater.from(context).inflate(R.layout.view_popupwindow_clinical, null);
    ...
    TextView tv_cancel,clinical_outpatient,clinical_remote;
    Button btn_1;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clinical_outpatient:
                popupWindow.dismiss();
                ((RecordDetailsActivity)mActivity).getData(MEDICALCASE,clinical_outpatient.getText().toString().trim());
                break;
            case R.id.clinical_remote:
                popupWindow.dismiss();
                ((RecordDetailsActivity)mActivity).getData(MEDICALCASE,clinical_remote.getText().toString().trim());
                break;
        }
    }
