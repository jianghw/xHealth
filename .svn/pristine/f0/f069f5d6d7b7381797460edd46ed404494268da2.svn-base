...
import com.kaurihealth.mvplib.mine_p.DoctorCompilePresenter;
import com.kaurihealth.mvplib.mine_p.IDoctorCompileView;
 ...
 * "我的"-->医生个人信息界面
 */
public class DoctorCompileActivity extends BaseActivity implements IDoctorCompileView {
    @Inject
    DoctorCompilePresenter<IDoctorCompileView> mPresenter;
    ...
    protected int getActivityLayoutID() {
        return R.layout.activity_doctor_compile;
    }
    ...
    @OnClick({R.id.iv_back, R.id.rlay_school, R.id.rlay_photo, R.id.rlay_post, R.id.rlay_department,
            R.id.rlay_num, R.id.rlay_organization, R.id.rlay_EducationLevel, R.id.rlay_studyexperience, R.id.rlay_good})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rlay_post://修改职称
                skipToForResult(SelectTitleActivity.class, null, 8);
                break;
            case R.id.rlay_department://科室
                Bundle bundle = new Bundle();
                bundle.putString(Global.Environment.BUNDLE, Global.Environment.UPDATE);
                skipToForResult(SelectDepartmentLevel1Activity.class, bundle, 14);
                break;
            case R.id.rlay_num://修改职业编号
                skipToForResult(EnterCertificationNumberActivity.class, null, 13);
                break;
            ...
            case R.id.rlay_organization://修改机构
                ...
                skipToForResult(EnterHospitalActivity.class, bundleOrganization, 12);
                break;
            case R.id.rlay_studyexperience://修改学习与工作经历
                skipToForResult(EnterStudyExperienceActivity.class, null, 10);
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == educationHistoryRequest){
            if (resultCode ==RESULT_OK){
                String graducation = data.getStringExtra("graducation");
                tvEducationHistory.setText(graducation);
            }
        }else{
            renderView();
