...
public class RecordPathologyAdapter extends CommonAdapter<TotalPathologyRecordCountsBean> {

    private ItemClickBack itemClickBack;

    public RecordPathologyAdapter(Context context, List<TotalPathologyRecordCountsBean> list) {
        super(context, list);
    }

    public RecordPathologyAdapter(Context context, List<TotalPathologyRecordCountsBean> list, ItemClickBack itemClickBack) {
        super(context, list);
    ...
    class ViewHolder {
        ...
        public void setInfo(TotalPathologyRecordCountsBean displayBean) {
