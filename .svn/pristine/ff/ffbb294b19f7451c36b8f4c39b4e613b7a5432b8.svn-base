...
//    private int id;
    ...
    public ContactUserDisplayBean(String kauriHealthId, String gender, String userType,
                                  String avatar, String fullName, Date dateOfBirth,boolean isTop,int primaryId) {
        this.kauriHealthId = kauriHealthId;
        this.gender = gender;
