...
public class TreatMentRelatedRecordsOnlyreadActivity extends BaseActivity {
    ...
    private static final int TREATMENTRELATEDRECORDS = 7 ;
    ...
    public void onMoreClick() {
        if (mTvMore.getText().equals(getString(R.string.swipe_tv_compile))) {
            ...
            skipToForResult(TreatmentRelatedRecordsActivity.class,null,TREATMENTRELATEDRECORDS);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode ==TREATMENTRELATEDRECORDS && resultCode == RESULT_OK){
            finishCur();
        }
    }
