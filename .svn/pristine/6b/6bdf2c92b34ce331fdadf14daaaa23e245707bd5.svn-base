...
public class AdmissionRecordOnlyReadActivity extends BaseActivity {
    ...
    private static final int ADMISSIONRECORD = 6;
    ...
    public void onMoreClick() {
        if (mTvMore.getText().equals(getString(R.string.swipe_tv_compile))) {
            ...
            skipToForResult(AdmissionRecordActivity.class, null, ADMISSIONRECORD);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADMISSIONRECORD && resultCode == RESULT_OK) {
                finishCur();
        }
    }
