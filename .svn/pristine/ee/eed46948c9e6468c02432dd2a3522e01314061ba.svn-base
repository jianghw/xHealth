 ...
 */
public class DoctorCompilePresenter<V> implements IDoctorCompilePresenter<V> {
    private final IDataSource mRepository;
    private CompositeSubscription mSubscriptions;
    private IDoctorCompileView mActivity;

    @Inject
    DoctorCompilePresenter(IDataSource repository) {
    ...
    public void setPresenter(V view) {
        mActivity = (IDoctorCompileView) view;
    }
