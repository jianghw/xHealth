...
import com.kaurihealth.chatlib.utils.LCIMSoftInputUtils;
...
public class LCIMInputBottomBar extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        referralBtn = findViewById(R.id.input_bar_btn_referral);
        ...
        sendTextBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EventBus.getDefault().post(new LCIMInputBottomBarTextEvent(LCIMInputBottomBarEvent.INPUTBOTTOMBAR_SEND_TEXT_ACTION, content, getTag()));
            }
        });
        ...
        pictureBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new LCIMInputBottomBarEvent(LCIMInputBottomBarEvent.INPUTBOTTOMBAR_IMAGE_ACTION, getTag()));
            }
        });
        ...
        cameraBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new LCIMInputBottomBarEvent(LCIMInputBottomBarEvent.INPUTBOTTOMBAR_CAMERA_ACTION, getTag()));
            }
        });

        //转诊
        referralBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new LCIMInputBottomBarEvent(LCIMInputBottomBarEvent.INPUTBOTTOMBAR_REFERRAL_ACTION, getTag()));
            }
        });
    }
        ...
        recordBtn.setRecordEventListener(new LCIMRecordButton.RecordEventListener() {
            ...
            public void onFinishedRecord(final String audioPath, int secs) {
                EventBus.getDefault().post(
                        new LCIMInputBottomBarRecordEvent(LCIMInputBottomBarEvent.INPUTBOTTOMBAR_SEND_AUDIO_ACTION, audioPath, secs, getTag()));
...
//        voiceBtn.setVisibility(contentEditText.getText().length() > 0 ? GONE : VISIBLE);
        voiceBtn.setVisibility(contentEditText.getText().length() > 0 ? VISIBLE : VISIBLE);
    ...
    public void setReferralBtnGone(boolean b) {
        referralBtn.setVisibility(b ? View.GONE : VISIBLE);
    }
}
