package com.kaurihealth.kaurihealth.doctor_new.view;
...
public class WaveSideBar extends View {
    private final static int DEFAULT_TEXT_SIZE = 10; // sp 14
    private final static int DEFAULT_MAX_OFFSET = 60; //dp 80
