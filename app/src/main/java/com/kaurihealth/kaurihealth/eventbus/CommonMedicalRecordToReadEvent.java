 ...
 */
public class CommonMedicalRecordToReadEvent {
    ...
    public CommonMedicalRecordToReadEvent(PatientRecordDisplayBean patientRecordDisplayBean, DoctorPatientRelationshipBean shipBean, String mark) {
