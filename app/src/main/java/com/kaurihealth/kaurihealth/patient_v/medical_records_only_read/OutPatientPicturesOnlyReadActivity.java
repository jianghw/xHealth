...
public class OutPatientPicturesOnlyReadActivity extends BaseActivity {
    ...
    private static final int OUTPATIENTPICTURES = 4;
    ...
    public void onMoreClick() {
        if (mTvMore.getText().equals(getString(R.string.swipe_tv_compile))) {
            ...
            skipToForResult(OutpatientPicturesActivity.class, null, OUTPATIENTPICTURES);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == OUTPATIENTPICTURES && resultCode == RESULT_OK){
            finishCur();
        }
    }
