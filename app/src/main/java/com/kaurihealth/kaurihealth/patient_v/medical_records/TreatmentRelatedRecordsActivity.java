...
/**
 *  医患-->医疗记录-->临床诊疗--> 院内治疗相关记录
 *  必填项：咨询时间， 科室，机构，医生
 * Created by Garnet_Wu on 2016/9/20.
 */
public class TreatmentRelatedRecordsActivity extends BaseActivity implements IOutpatientElectronicView ,Validator.ValidationListener{
    @Inject
