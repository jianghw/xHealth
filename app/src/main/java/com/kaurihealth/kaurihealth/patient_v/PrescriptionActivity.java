...
public class PrescriptionActivity extends BaseActivity implements IPrescriptionView {
    ...
    @Bind(R.id.tv_more)
    TextView mTvMore;
    @Bind(R.id.lv_content)   //下拉刷新对象
    ListView lvContent;
    @Bind(R.id.swipe_refresh)   //swipe_refresh 下拉刷新Google原生
    SwipeRefreshLayout refreshTool;
    @Bind(R.id.tv_prescription_tips)    //还没添加处方，请您添加 (处方备注)
...
//        getData();
        ...
        lvContent.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                EventBus.getDefault().postSticky(new EditPrescriptionNewBeanEvent(prescriptionBean, doctorPatientRelationshipBean, isAble));//EventBus发送消息被AddAndEditPrescriptionActivityNew接收
                skipTo(AddAndEditPrescriptionActivityNew.class);
            }
        });
    }
