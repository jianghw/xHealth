...
class AccessoryRecordCommonView extends AbstractViewController<PatientRecordDisplayDto> implements CollapsibleGroupView.ChildGroupView {
    ...
    AccessoryRecordCommonView(Context context,String title) {
        super(context);
        this.mTitle = title;
    }
