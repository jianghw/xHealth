...
public class OtherOfLabTestView extends AbstractViewController<List<PatientRecordDisplayDto>>
            implements CollapsibleLinearLayout.ListViewItemClick{

    @Bind(R.id.lay_other)
    CollapsibleLinearLayout lay_other;
    ...
    public OtherOfLabTestView(Context context) {
        super(context);
    }

    @Override
    protected int getResLayoutId() {
        return R.layout.include_other_of_lob;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        bundle.putString(Global.Bundle.ITEM_Lob,"其它");
