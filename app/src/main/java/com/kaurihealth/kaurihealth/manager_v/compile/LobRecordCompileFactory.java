...
public class LobRecordCompileFactory implements IViewFactory<PatientRecordDisplayDto>{
     ...
     * 实验室检查信息通用模块
     */
    LobRecordCommonView mRecordCommonView;


    public LobRecordCompileFactory(Context context, String mTitle){
    ...
    public void createIncludeViews() {
        ...
        mRecordCommonView = new LobRecordCommonView(mContext,mTitle);
    }
