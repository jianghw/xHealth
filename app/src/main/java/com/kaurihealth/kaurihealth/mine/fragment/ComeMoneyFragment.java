...
import com.kaurihealth.kaurihealth.mine.adapter.MoneyComeAdapter;
...
public class ComeMoneyFragment extends CommonFragment {
    @Bind(R.id.tvMoney)
    TextView tvMoney;
    ...
    private void initUi() {
        ...
        adapter = new MoneyComeAdapter(getContext(), dataContainer);
