...
public class RemoteFragment extends CommonFragment implements FragmentData<JsonNode>, FragmentControl {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_remote, null);
