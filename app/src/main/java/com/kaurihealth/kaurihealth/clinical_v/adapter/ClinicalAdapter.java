            ...
            case TYPE_CATEGORY_ITEM:
                ...
                tv_gendo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        bundle.putSerializable("medicalLiteratureDisPlayBeanList",
                                clinicalUtil.getMedicalLiteratureDisPlayBeanArrayList(medicalLiteratureDisPlayBeanList, itemValue));
            ...
            case TYPE_ITEM:
                ...
                if (item instanceof MedicalLiteratureDisPlayBean) {
                    if (((MedicalLiteratureDisPlayBean) item).titleImage != null) {
                        ImageUrlUtils.picassoBySmallUrlReference(context, ((MedicalLiteratureDisPlayBean) item).titleImage, viewHolder.ivTitleImage);
                    } else {
                        viewHolder.ivTitleImage.setImageResource(R.mipmap.ic_clinical_rectangle);
