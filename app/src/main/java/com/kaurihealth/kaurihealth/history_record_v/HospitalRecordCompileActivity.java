 ...
 * Describle: 住院记录
 */
public class HospitalRecordCompileActivity extends BaseActivity {
    ...
    private HospitalRecordCompileFactory viewFactory;
    ...
    public void loadPatientRecordSucceed(PatientRecordDisplayDto displayDto) {
        ...
        if (viewFactory == null) {
            viewFactory = (HospitalRecordCompileFactory) ViewFactoryManager.createViewFactory(this, mLayContent);
        } else {
    ...
    public void addMoreClick() {
        skipToForResult(HospitalRecordSaveActivity.class,null, Global.RequestCode.RECORD_COMPILE_HOSPITAL);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        if (requestCode == Global.RequestCode.RECORD_COMPILE_HOSPITAL && resultCode == RESULT_OK) {
