...
public class MessageFragment extends BaseFragment implements IMessageView {
    ...
    public void isReadNotifySucceed(NotifyIsReadDisplayBean bean) {
        ...
        mImgUnreadSystem.setVisibility(bean.isIsRead() ? View.VISIBLE : View.GONE);
        mTvTimeSystem.setVisibility(bean.isIsRead() ? View.VISIBLE : View.GONE);
    }
                ...
                .map(new Func1<AVObject, Integer>() {
                    ...
                    public Integer call(AVObject object) {
                        if (object.get("attr") != null) {
                            ...
                            if (attr != null) {
                                try {
                                    return attr.getInt(Global.LeanCloud.ATTR_TYPE);//type为一是群聊
                                } catch (Exception e) {
                                    return 0;
                                }
                            } else {
